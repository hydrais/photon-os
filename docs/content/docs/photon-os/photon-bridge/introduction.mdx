---
title: Get Started with Photon Bridge
description: Communicate with scripted objects in Second Life from your Photon apps using Photon Bridge
---
...
1. [Link your Second Life](/docs/photon-os/using-photon-os/introduction) account to your Photon account. (Settings > Account)
